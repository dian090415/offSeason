...
public abstract class AbstractArm {
  ...
  public class Positions {
    // NEW HAND
    public static final ArmPosition GROUND_CORAL = new ArmPosition(Degrees.of(5.1), ElevatorConstants.MIN_LENGTH,
        Degrees.of(-5.1));
    ...
    public static final ArmPosition HIGH_ALGAE_REEF = new ArmPosition(Degrees.of(90),
        Meters.of(1.025).plus(Inches.of(4)), Degrees.of(90 + 25));
